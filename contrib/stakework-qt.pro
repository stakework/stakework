...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/stakework-cli.cpp \
           src/stakework-tx.cpp \
           src/stakework.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/stakework.qrc src/qt/stakework_locale.qrc

TRANSLATIONS += src/qt/locale/stakework_bg.ts \
                src/qt/locale/stakework_de.ts \
                src/qt/locale/stakework_en.ts \
                src/qt/locale/stakework_es.ts \
                src/qt/locale/stakework_fi.ts \
                src/qt/locale/stakework_fr.ts \
                src/qt/locale/stakework_it.ts \
                src/qt/locale/stakework_ja.ts \
                src/qt/locale/stakework_pl.ts \
                src/qt/locale/stakework_pt.ts \
                src/qt/locale/stakework_ru.ts \
                src/qt/locale/stakework_sk.ts \
                src/qt/locale/stakework_sv.ts \
                src/qt/locale/stakework_vi.ts \
                src/qt/locale/stakework_zh_CN.ts \
                src/qt/locale/stakework_zh_TW.ts
