...
#   c) node1 mines 32 blocks, so now node 0 has 60001stakework, node 1 has 4250stakework, node2 has none.
#   d) node0 sends 601 stakework to node2, in two transactions (301 stakework, then 300 stakework).
