...
In order to support loading of multiple wallets in stakework-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stakework.cpp.
...
Changes to stakework.cpp
----------------------
stakework.cpp is the entry point into stakework-qt, and as such, will require some minor modifications to provide hooks for
