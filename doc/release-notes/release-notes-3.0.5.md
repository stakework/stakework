Stakework Core version 3.0.5 is now available from:
...
Stakework Core version 3.0.5 is a recommended update for all users. This release
...
installer (on Windows) or just copy over `/Applications/Stakework-Qt` (on Mac)
or `stakeworkd`/`stakework-qt` (on Linux).

Compatibility
=============

Stakework Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

Stakework Core should also work on most other Unix-like systems but is not
...
- `0789160` Fix: check doc script failed due to misspelled backupxSKW instead of backupxion (cevap)
...
- `44e16ef` Replace all occurencies of SKW-Qt with Stakework-Qt (cevap)
- `e36f97a` Add splashscreens, fixed #10 (cevap)
- `1a08917` Rename all occurencies from ' SKW ' to ' Stakework ' (cevap)
...
- `6439a59` Rename bitcoin.org to stakework.xyz, ref: #13 (cevap)
...
- `e17311c` Stakeworkian Documentation (#23) (ckti)
- `9d05d8e` Stakework Build Documaentation for Raspian (#24) (ckti)
