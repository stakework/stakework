...
This mechanism has been integrated into Bitcore-Node-SKW which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cevap/insight-api-stakework#web-socket-api](https://github.com/cevap/insight-api-stakework#web-socket-api) 
* API: [https://github.com/cevap/insight-api-stakework#swifttx-transactions](https://github.com/cevap/insight-api-stakework#swifttx-transactions) 
...
By default, the Stakework Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stakework Core daemon:
