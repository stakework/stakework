Stakework build instructions for Raspian
======================================
To build stakework the following packages need to be installed on the system:
---------------------------------------------------------------------------
...
Download the stakework sourcecode from github
-------------------------------------------

git clone https://github.com/cevap/stakework.git -b master --depth=1

Build the stakework package
-------------------------
cd stakework  
./autogen.sh  
...
Enter a name such as Stakework in this example
