...
The Stakework Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Stakework Core project, and is not to be
confused with overall Stakework Network Protocol consensus changes.

Whether a pull request is merged into Stakework Core rests with the project merge
...
Patches that change Stakework consensus rules are considerably more involved than
...
Where a patch set proposes to change the Stakework consensus, it must have been
