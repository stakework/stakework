...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Stakework initiative\n"
            "  vote-alias         - Vote on a Stakework initiative\n"
            "  vote               - Vote on a Stakework initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"stakework-address\" monthy-payment\n"
            ...
            "5. \"stakework-address\":   (string, required) Stakework address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.stakework-coin.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.stakework-coin.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"stakework-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.stakework-coin.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.stakework-coin.com/t/test-proposal\" 2 820800 \"idaeAtzaCGnJ5SUPXKoFxtgzbvv5nfBSDn\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) Stakework address of payment\n"
