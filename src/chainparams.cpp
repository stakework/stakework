...
*/
	...
	vSeeds.push_back(CDNSSeedData("node1", "node1.stakework.com"));
        ...
        strObfuscationPoolDummyAddress = "StakeworkDarksendPoo1DummyAdy4viSr";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "testnet.seeder.baseserv.com")); // Stakework's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "testnet.seeder.uksafedns.net")); // Stakework's official testseed 2
        // Testnet Stakework addresses start with 'g'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 0x496f6e;                // hex 57 47 52 in text = SKW
