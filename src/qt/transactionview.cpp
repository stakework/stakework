 ...
 */
    ...
    typeWidget->addItem(tr("Received Stakework from xSKW"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xSKW"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xSKW));
