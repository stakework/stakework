                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Stakework Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xSKW"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Stakework Core"), this);
    aboutAction->setStatusTip(tr("Show information about Stakework Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SKW"));
    ...
    openAction->setStatusTip(tr("Open a SKW: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stakework Core help message to get a list with possible Stakework command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Stakework Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Stakework Core"); // default title
