...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total stakework balance of the wallet (excluding zerocoins)\n"
...
/*            "  \"xSKWsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 xSKW denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 xSKW denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 xSKW denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 xSKW denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 xSKW denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 xSKW denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 xSKW denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 xSKW denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all xSKW denominations\n"
            "  }\n"
*/            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in stakework/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in stakework/kb\n"
    ...
    //obj.push_back(Pair("xSKWsupply", xionObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"stakeworkaddress\"     (string, required) The stakework address to validate\n"
            "\nResult:\n"
            "{\n"
