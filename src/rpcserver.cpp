...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Stakework features */
        {"stakework", "masternode", &masternode, true, true, false},
        {"stakework", "listmasternodes", &listmasternodes, true, true, false},
        {"stakework", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stakework", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stakework", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stakework", "masternodedebug", &masternodedebug, true, true, false},
        {"stakework", "startmasternode", &startmasternode, true, true, false},
        {"stakework", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stakework", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stakework", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stakework", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stakework", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stakework", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stakework", "mnbudget", &mnbudget, true, true, false},
        {"stakework", "preparebudget", &preparebudget, true, true, false},
        {"stakework", "submitbudget", &submitbudget, true, true, false},
        {"stakework", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stakework", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stakework", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stakework", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stakework", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stakework", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stakework", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stakework", "checkbudgets", &checkbudgets, true, true, false},
        {"stakework", "mnsync", &mnsync, true, true, false},
        {"stakework", "spork", &spork, true, true, false},
        {"stakework", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"stakework", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
